...
function submitBlog(event) {
    // fungsi dari even dan preventDefault adalah menahan agar si browser tidak langsung mengrefresh halaman
    // ketika kita input data, agar kita tau datanya sudah masuk atau belum jika via console
